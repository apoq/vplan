...
/**
 * Base class that represents a row from the 'vp_users_plans' table.
 *
 *
 *
 * @package    propel.generator.App.Models.Base
 */
abstract class VpUsersPlans implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\Models\\Map\\VpUsersPlansTableMap';
    ...
    /**
     * Initializes internal state of App\Models\Base\VpUsersPlans object.
     */
    ...
    /**
     * Compares this with another <code>VpUsersPlans</code> instance.  If
     * <code>obj</code> is an instance of <code>VpUsersPlans</code>, delegates to
     * <code>equals(VpUsersPlans)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|VpUsersPlans The current object, for fluid interface
     */
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[VpUsersPlansTableMap::COL_USER_ID] = true;
        }

        if ($this->aVpUsers !== null && $this->aVpUsers->getId() !== $v) {
            $this->aVpUsers = null;
        }
    ...
    public function setPlanId($v)
    {
        ...
        if ($this->plan_id !== $v) {
            $this->plan_id = $v;
            $this->modifiedColumns[VpUsersPlansTableMap::COL_PLAN_ID] = true;
        }
    ...
    {
        if ($this->aVpUsers !== null && $this->user_id !== $this->aVpUsers->getId()) {
            $this->aVpUsers = null;
        }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildVpUsersPlansQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see VpUsersPlans::setDeleted()
     * @see VpUsersPlans::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildVpUsersPlansQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                VpUsersPlansTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aVpUsers !== null) {
                if ($this->aVpUsers->isModified() || $this->aVpUsers->isNew()) {
                    $affectedRows += $this->aVpUsers->save($con);
                }
                $this->setVpUsers($this->aVpUsers);
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(VpUsersPlansTableMap::COL_PLAN_ID)) {
            $modifiedColumns[':p' . $index++]  = 'plan_id';
        }

        $sql = sprintf(
            'INSERT INTO vp_users_plans (%s) VALUES (%s)',
    ...
    {
        $pos = VpUsersPlansTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['VpUsersPlans'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aVpUsers) {
                ...
                $result[$key] = $this->aVpUsers->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\App\Models\VpUsersPlans
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\Models\VpUsersPlans The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\Models\VpUsersPlans (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\Models\VpUsersPlans Clone of current object.
     * @throws PropelException
     */
    ...
    /**
     * Declares an association between this object and a ChildVpUsers object.
     *
     * @param  ChildVpUsers $v
     * @return $this|\App\Models\VpUsersPlans The current object (for fluent API support)
     * @throws PropelException
     */
    public function setVpUsers(ChildVpUsers $v = null)
    {
        if ($v === null) {
            $this->setUserId(NULL);
        } else {
        ...
        // If this object has already been added to the ChildVpUsers object, it will not be re-added.
        if ($v !== null) {
            $v->addVpUsersPlans($this);
        }
    ...
    /**
     * Get the associated ChildVpUsers object
     *
     * @param  ConnectionInterface $con Optional Connection object.
     * @return ChildVpUsers The associated ChildVpUsers object.
     * @throws PropelException
     */
    public function getVpUsers(ConnectionInterface $con = null)
    {
        if ($this->aVpUsers === null && ($this->user_id != 0)) {
            $this->aVpUsers = ChildVpUsersQuery::create()->findPk($this->user_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aVpUsers->addVpUsersPlanss($this);
             */
        }

        return $this->aVpUsers;
    }
    ...
    public function getVpPlans(ConnectionInterface $con = null)
    {
        if ($this->aVpPlans === null && (($this->plan_id !== "" && $this->plan_id !== null))) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aVpPlans->addVpUsersPlanss($this);
             */
        }
    ...
    {
        if (null !== $this->aVpUsers) {
            $this->aVpUsers->removeVpUsersPlans($this);
        }
        if (null !== $this->aVpPlans) {
    ...
    {
        return (string) $this->exportTo(VpUsersPlansTableMap::DEFAULT_STRING_FORMAT);
    }
