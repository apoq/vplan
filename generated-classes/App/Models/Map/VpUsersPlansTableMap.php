...
/**
 * This class defines the structure of the 'vp_users_plans' table.
 *
 *
 *
 ...
 *
 */
class VpUsersPlansTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'App.Models.Map.VpUsersPlansTableMap';
     ...
     */
    const TABLE_NAME = 'vp_users_plans';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\App\\Models\\VpUsersPlans';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'App.Models.VpUsersPlans';
     ...
     */
    const COL_USER_ID = 'vp_users_plans.user_id';

    /**
     * the column name for the plan_id field
     */
    const COL_PLAN_ID = 'vp_users_plans.plan_id';
    ...
    {
        // attributes
        $this->setName('vp_users_plans');
        $this->setPhpName('VpUsersPlans');
    ...
    {
        $this->addRelation('VpUsers', '\\App\\Models\\VpUsers', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':user_id',
    1 => ':id',
  ...
  array (
    ...
    {
        return $withPrefix ? VpUsersPlansTableMap::CLASS_DEFAULT : VpUsersPlansTableMap::OM_CLASS;
    }
     ...
     * @return array           (VpUsersPlans object, last column rank)
     */
    public static function populateObject($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        $key = VpUsersPlansTableMap::getPrimaryKeyHashFromRow($row, $offset, $indexType);
        if (null !== ($obj = VpUsersPlansTableMap::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $offset, true); // rehydrate
            $col = $offset + VpUsersPlansTableMap::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = VpUsersPlansTableMap::OM_CLASS;
            /** @var VpUsersPlans $obj */
            $obj = new $cls();
            $col = $obj->hydrate($row, $offset, false, $indexType);
            VpUsersPlansTableMap::addInstanceToPool($obj, $key);
        }
    ...
    public static function populateObjects(DataFetcherInterface $dataFetcher)
    {
        ...
        while ($row = $dataFetcher->fetch()) {
            $key = VpUsersPlansTableMap::getPrimaryKeyHashFromRow($row, 0, $dataFetcher->getIndexType());
            if (null !== ($obj = VpUsersPlansTableMap::getInstanceFromPool($key))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
    ...
    {
        return Propel::getServiceContainer()->getDatabaseMap(VpUsersPlansTableMap::DATABASE_NAME)->getTable(VpUsersPlansTableMap::TABLE_NAME);
    }
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(VpUsersPlansTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(VpUsersPlansTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new VpUsersPlansTableMap());
        }
    }

    /**
     * Performs a DELETE on the database, given a VpUsersPlans or Criteria object OR a primary key value.
     *
     * @param mixed               $values Criteria or VpUsersPlans object or primary key or array of primary keys
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \App\Models\VpUsersPlans) { // it's a model object
        ...
        if ($values instanceof Criteria) {
            ...
            foreach ((array) $values as $singleval) {
                VpUsersPlansTableMap::removeInstanceFromPool($singleval);
            }
        }
    ...
    {
        return VpUsersPlansQuery::create()->doDeleteAll($con);
    }

    /**
     * Performs an INSERT on the database, given a VpUsersPlans or Criteria object.
     *
     * @param mixed               $criteria Criteria or VpUsersPlans object containing data that is used to create the INSERT statement.
...
} // VpUsersPlansTableMap
// This is the static code needed to register the TableMap for this table with the main Propel class.
//
VpUsersPlansTableMap::buildTableMap();
